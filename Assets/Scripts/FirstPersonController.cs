...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    {
        //All of these values showing warnings are assigned inside the Unity development environment
        ...
        private void Start()
        {
            ...
            vaultTypes = gameObject.AddComponent<Vaults>();
